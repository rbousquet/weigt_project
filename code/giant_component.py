...
def get_dataset(N_sample,N,P) :
    data=[]
    for n in N :
        proba=[]
        print(f"Importing data N={n} ...")
        for p in P :
            file = f"./graphs/N_sample{N_sample}_N{n}_p{p:.4f}.npy"
